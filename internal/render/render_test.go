...
func TestHomeOrdersPostsAndEscapesThreeSentenceExcerpts(t *testing.T) {
	...
	intro := `<p class="homepage-intro">Hi, I am Paul and I am a Staff Engineer and Engineering Manager from Germany. Talk to me on <a href="https://www.linkedin.com/in/paul-heymann-6b4a53144/">LinkedIn</a> or send me an email at <a href="mailto:contact@paulheymann.de">contact@paulheymann.de</a>.</p>`
