...
Irrelevant Tags Do Not Generate A Preview
    ...
    Write Pipeline Fixture    ignored.md    ${content}
    Sleep    2 sec
...
Title Changes Preserve A Redirect To The Updated Post
    ...
    Write Pipeline Fixture    renamed.md    ${original}
    ...
    Write Pipeline Fixture    renamed.md    ${updated}
...
Wiki Links And Vault Images Render In The Preview
    ...
    ${source}=    Catenate    SEPARATOR=\n    ---    date: 2026-09-05    ---    \# Pipeline Source    \#blog \#engineering \#preview    See [[Pipeline Target|the target]].    ${EMPTY}    ![Fixture image](pipeline-image.svg)
    Write Pipeline Fixture    target.md    ${target}
    Write Pipeline Fixture    source.md    ${source}
...
Validation Failure Leaves The Last Valid Preview Available
    ...
    Write Pipeline Fixture    rollback.md    ${valid}
    ...
    Write Pipeline Fixture    rollback.md    ${invalid}
    Sleep    2 sec
    ...
    Should Contain    ${journal}    rollback.md: date property is required
